...
#ifndef ODEXGSSIMPLEDEVICE
#define ODEXGSSIMPLEDEVICE
...
public:
  ...
  /*                                                                    */
  /* Retrieves the current vectorization traits from ODA Drawings SDK   */
  /* (color lineweight, etc.) and sets them in this device.             */
  /**********************************************************************/
